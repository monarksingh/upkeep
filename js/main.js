...
function sendFormDetails(form, url) {
...
jQuery(document).ready(function() {
	...
	var contactUsForm = jQuery('form.contact-form');
	sendFormDetails(contactUsForm, "contact-form.php");

	var requestVisitForm = jQuery('form.requestVisitForm');
	sendFormDetails(requestVisitForm, "requestVisitForm.php");
